...
import { ArrowDownToLine, ArrowRight, BarChart3, BookOpen, Bot, Box, Check, ChevronDown, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, CircleHelp, Clock3, Crown, Expand, Flag, Grid2X2, Keyboard, Lightbulb, Loader2, Maximize2, MousePointer2, RotateCcw, RotateCw, Settings2, ShieldCheck, Shuffle, SlidersHorizontal, Sparkles, Swords, Undo2, Video, Volume2, VolumeX, X } from "lucide-react"
  ...
  return <div className={`gambit-app ${focus ? "is-focused" : ""}`}>
    ...
    <div className="app-main">
      ...
      <main className="workspace">
        <div className="page-heading"><div><div className="eyebrow">A FRESH PERSPECTIVE ON A CLASSIC</div><h1>Your next great move.</h1><p>Settle in, find your focus, and enjoy the game.</p></div><div className="experience-badge"><Box size={17} /><span>A new dimension of chess</span><span className="tiny-pill">3D</span></div></div>
